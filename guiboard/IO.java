package guiboard;//
// Port guiboard.IO emulator class. All read/writes are send over TCP/IP to the host
// using a dedicated protocol on port 81.
// Use guiboard.IO.init(host, port) to modify behaviour
// by Wim Verhoef
...
public class IO {
  ...
  /**
   * Initialize.
   * Before calling the emulated guiboard.IO routines, use one of the init routines
...
//============================= below are the support routines =====================
  ...
  synchronized private static short remoteIO(short IOCode, short address, short value) {
    if (client == null)
      return (short) - 1;
